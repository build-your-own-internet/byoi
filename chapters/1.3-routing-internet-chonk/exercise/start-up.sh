...
router1)
  ...
  ip route add 2.1.1.16/29 via 2.1.1.11
  ;;
router2)
  ip route add 1.0.0.0/8 via 100.1.3.1
  ip route add 3.0.0.0/8 via 100.1.3.1
  ip route add 5.0.0.0/8 via 2.1.1.10
  ip route add 2.1.1.16/29 via 2.1.1.3
  ;;
router3)
  ip route add 5.0.0.0/8 via 3.0.1.1
  ip route add 1.0.0.0/8 via 100.1.2.1
  ip route add 2.1.1.8/29 via 3.0.1.1
  ip route add 2.1.1.0/29 via 100.1.2.1
  ip route add 2.1.1.16/29 via 100.1.4.1
  ;;
router4)
  ip route add 1.0.0.0/8 via 100.1.5.1
  ip route add 3.0.0.0/8 via 100.1.3.1
  ip route add 5.0.0.0/8 via 100.1.3.1
  ip route add 2.1.1.8/29 via 2.1.1.2
  ;;
router5)
  ip route add 3.0.0.0/8 via 100.1.3.1
  ip route add 5.0.0.0/8 via 2.1.1.18
  ip route add 2.1.1.8/29 via 100.1.2.1
  ip route add 2.1.1.0/29 via 2.1.1.18
  ;;
esac
